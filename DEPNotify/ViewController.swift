    ...
    func processCommand(command: String) {
        ...
        case "Video:":
            ...
            if videoURL.hasPrefix("http") { // If the URL provided is HTTP then stream
                ...
                // Loop Video
                NotificationCenter.default.addObserver(forName: NSNotification.Name.AVPlayerItemDidPlayToEndTime, object: myPlayer.currentItem, queue: nil) { _ in
        ...
        case "Restart:":
            ...
            alertController.beginSheetModal(for: NSApp.windows[0]) { _ in
                self.reboot()
                NSApp.terminate(self)
            }
